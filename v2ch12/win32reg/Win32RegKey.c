...
JNIEXPORT jobject JNICALL Java_Win32RegKey_getValue(
    ...
    /* get the class */
    jclass this_class = (*env)->GetObjectClass(env, this_obj);
    ...
    /* get the fields */
    HKEY root = (HKEY) (*env)->GetIntField(env, this_obj, id_root);
    jstring path = (jstring) (*env)->GetObjectField(env, this_obj, id_path);
...
JNIEXPORT void JNICALL Java_Win32RegKey_setValue(
    ...
    jclass class_value = (*env)->GetObjectClass(env, value);
    jclass class_Integer = (*env)->FindClass(env, "java/lang/Integer");
    ...
    if ((*env)->IsAssignableFrom(env, class_value, (*env)->FindClass(env, "java/lang/String"))) {
        ...
        int ivalue = (*env)->CallIntMethod(env, value, id_intValue);
        type = REG_DWORD;
        cvalue = (char*) &ivalue;
        size = 4;
    }
...
static int startNameEnumeration(JNIEnv* env, jobject this_obj, jclass this_class) {
    ...
    if (RegQueryInfoKey(hkey, NULL, NULL, NULL, NULL, NULL, NULL,
        &count, &maxsize, NULL, NULL, NULL) != ERROR_SUCCESS) {
...
JNIEXPORT jboolean JNICALL Java_Win32RegKeyNameEnumeration_hasMoreElements(JNIEnv* env, jobject this_obj) {
    ...
    int index = (*env)->GetIntField(env, this_obj, id_index);
    int count;
...
JNIEXPORT jstring JNICALL Java_Win32RegKeyNameEnumeration_nextElement(JNIEnv* env, jobject this_obj) {
    ...
    DWORD maxsize = (*env)->GetIntField(env, this_obj, id_maxsize);
    HKEY hkey = (HKEY) (*env)->GetIntField(env, this_obj, id_hkey);
